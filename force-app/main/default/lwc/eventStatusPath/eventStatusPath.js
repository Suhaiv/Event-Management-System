...
async saveCancellation() {
    ...
    try {
        ...
        // Reason save
        fields[REASON_FIELD.fieldApiName] =
...
get isCancelDisabled() {
    ...
    get steps() {
        ...
        if (currentIndex === -1 && this.currentStatus) {
            ...
            console.warn(
                'Status__c value "' + this.currentStatus +
        ...
        return this.statusOrder.map((status, index) => {
            ...
            if (currentNorm === 'cancelled') {
                ...
                } else if (index < this.statusOrder.findIndex(s => this.normalize(s) === 'cancelled')) {
                ...
                } else if (index < this.statusOrder.findIndex(s => this.normalize(s) === 'post poned')) {
                    className = 'step completed';
                    showCheck = true;
                }
            } else {
